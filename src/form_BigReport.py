...
class Ui_frmBigReport(object):
    ...
    def retranslateUi(self, frmBigReport):
        ...
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabItinerary), _translate("frmBigReport", "Itinerary"))
