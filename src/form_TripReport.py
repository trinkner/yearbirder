...
# Form implementation generated from reading ui file 'TripReport.ui'
#
...
class Ui_frmTripReport(object):
    def setupUi(self, frmTripReport):
        frmTripReport.setObjectName("frmTripReport")
        frmTripReport.resize(1000, 625)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frmTripReport.sizePolicy().hasHeightForWidth())
        frmTripReport.setSizePolicy(sizePolicy)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon_tripreport_white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        frmTripReport.setWindowIcon(icon)
        self.scrollArea = QtWidgets.QScrollArea(frmTripReport)
        ...
        self.tabItinerary = QtWidgets.QWidget()
        self.tabItinerary.setObjectName("tabItinerary")
        self.verticalLayout_Itinerary = QtWidgets.QVBoxLayout(self.tabItinerary)
        self.verticalLayout_Itinerary.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_Itinerary.setSpacing(0)
        self.verticalLayout_Itinerary.setObjectName("verticalLayout_Itinerary")
        self.tabAnalysis.addTab(self.tabItinerary, "")
        ...
        self.tblNewYearSpecies.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        ...
        self.tblNewMonthSpecies.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        ...
        self.tblNewCountrySpecies.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        ...
        self.tblNewStateSpecies.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        ...
        self.tblNewCountySpecies.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        ...
        self.tblNewLocationSpecies.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        ...
        self.actionSetDateFilter = QtGui.QAction(frmTripReport)
        self.actionSetDateFilter.setObjectName("actionSetDateFilter")
        self.actionSetLocationFilter = QtGui.QAction(frmTripReport)
        self.actionSetLocationFilter.setObjectName("actionSetLocationFilter")
        self.actionSetFirstDateFilter = QtGui.QAction(frmTripReport)
        self.actionSetFirstDateFilter.setObjectName("actionSetFirstDateFilter")
        self.actionSetLastDateFilter = QtGui.QAction(frmTripReport)
        self.actionSetLastDateFilter.setObjectName("actionSetLastDateFilter")
        self.actionSetSpeciesFilter = QtGui.QAction(frmTripReport)
        self.actionSetSpeciesFilter.setObjectName("actionSetSpeciesFilter")
        self.actionSetCountryFilter = QtGui.QAction(frmTripReport)
        self.actionSetCountryFilter.setObjectName("actionSetCountryFilter")
        self.actionSetStateFilter = QtGui.QAction(frmTripReport)
        self.actionSetStateFilter.setObjectName("actionSetStateFilter")
        self.actionSetCountyFilter = QtGui.QAction(frmTripReport)
        self.actionSetCountyFilter.setObjectName("actionSetCountyFilter")
        self.actionSetDateFilterToYear = QtGui.QAction(frmTripReport)
        self.actionSetDateFilterToYear.setObjectName("actionSetDateFilterToYear")
        self.actionSetDateFilterToMonth = QtGui.QAction(frmTripReport)
        self.actionSetDateFilterToMonth.setObjectName("actionSetDateFilterToMonth")

        self.retranslateUi(frmTripReport)
        self.tabAnalysis.setCurrentIndex(2)
        QtCore.QMetaObject.connectSlotsByName(frmTripReport)

    def retranslateUi(self, frmTripReport):
        _translate = QtCore.QCoreApplication.translate
        frmTripReport.setWindowTitle(_translate("frmTripReport", "Location Report"))
        self.lblLocation.setText(_translate("frmTripReport", "Location"))
        self.lblDateRange.setText(_translate("frmTripReport", "Date Range"))
        self.lblDetails.setText(_translate("frmTripReport", "Details Label"))
        self.lblLocationsVisited.setText(_translate("frmTripReport", "Locations Visited:"))
        self.lblTopSpeciesSeen.setText(_translate("frmTripReport", "Species Seen:"))
        self.tblSpecies.setSortingEnabled(True)
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabSpecies), _translate("frmTripReport", "Species"))
        self.lblDatesSeen.setText(_translate("frmTripReport", "Dates"))
        self.lstDates.setSortingEnabled(False)
        self.lblSpeciesSeen.setText(_translate("frmTripReport", "Species Seen on Selected Date"))
        self.lstSpecies.setSortingEnabled(False)
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabDates), _translate("frmTripReport", "Dates"))
        self.lblLocations.setText(_translate("frmTripReport", "Locations"))
        self.lstLocations.setSortingEnabled(False)
        self.lblLocationSpecies.setText(_translate("frmTripReport", "Species seen at Selected Location"))
        self.lstLocationSpecies.setSortingEnabled(False)
        self.lblLocationUniqueSpecies.setText(_translate("frmTripReport", "Species seen ONLY at Selected Location"))
        self.lstLocationUniqueSpecies.setSortingEnabled(False)
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabLocations), _translate("frmTripReport", "Locations"))
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabMap), _translate("frmTripReport", "Map"))
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabItinerary), _translate("frmTripReport", "Itinerary"))
        self.lblNewLifeSpecies.setText(_translate("frmTripReport", "New Life Species"))
        self.lblNewYearSpecies.setText(_translate("frmTripReport", "New Year Species"))
        self.tblNewYearSpecies.setSortingEnabled(True)
        self.lblNewMonthSpecies.setText(_translate("frmTripReport", "New Species for Month Range"))
        self.tblNewMonthSpecies.setSortingEnabled(True)
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabNewDates), _translate("frmTripReport", "New for Dates"))
        self.lblNewCountrySpecies.setText(_translate("frmTripReport", "New Country Species"))
        self.tblNewCountrySpecies.setSortingEnabled(True)
        self.lblNewStateSpecies.setText(_translate("frmTripReport", "New State Species"))
        self.tblNewStateSpecies.setSortingEnabled(True)
        self.lblNewCountySpecies.setText(_translate("frmTripReport", "New County Species"))
        self.tblNewCountySpecies.setSortingEnabled(True)
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabNewRegions), _translate("frmTripReport", "New for Regions"))
        self.lblNewLocationSpecies.setText(_translate("frmTripReport", "New Location Species"))
        self.tblNewLocationSpecies.setSortingEnabled(True)
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabNewLocations), _translate("frmTripReport", "New for Locations"))
        self.actionSetDateFilter.setText(_translate("frmTripReport", "Set Filter to Date"))
        self.actionSetLocationFilter.setText(_translate("frmTripReport", "Set Filter to Location"))
        self.actionSetFirstDateFilter.setText(_translate("frmTripReport", "Set Filter to \"First\" Date"))
        self.actionSetLastDateFilter.setText(_translate("frmTripReport", "Set Filter to \"Last\" Date"))
        self.actionSetSpeciesFilter.setText(_translate("frmTripReport", "Set Filter to Species"))
        self.actionSetCountryFilter.setText(_translate("frmTripReport", "Set Filter to Country"))
        self.actionSetStateFilter.setText(_translate("frmTripReport", "Set Filter to State"))
        self.actionSetCountyFilter.setText(_translate("frmTripReport", "Set Filter to County"))
        self.actionSetDateFilterToYear.setText(_translate("frmTripReport", "Set Filter To Year"))
        self.actionSetDateFilterToMonth.setText(_translate("frmTripReport", "Set Filter to Month"))
