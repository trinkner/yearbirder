...
class Ui_frmFind(object):
    def setupUi(self, frmFind):
        ...
        self.frameMain.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.frameCheckboxesLeft.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.frameCheckboxesLeft.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.chkPhotoNotes = QtWidgets.QCheckBox(self.frameCheckboxesLeft)
        self.chkPhotoNotes.setChecked(True)
        self.chkPhotoNotes.setObjectName("chkPhotoNotes")
        self.verticalLayout_2.addWidget(self.chkPhotoNotes)
        self.horizontalLayout_2.addWidget(self.frameCheckboxesLeft)
        self.frameCheckboxesRight = QtWidgets.QFrame(self.frame_2)
        self.frameCheckboxesRight.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.frameCheckboxesRight.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.chkRecordingNotes = QtWidgets.QCheckBox(self.frameCheckboxesRight)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.chkRecordingNotes.sizePolicy().hasHeightForWidth())
        self.chkRecordingNotes.setSizePolicy(sizePolicy)
        self.chkRecordingNotes.setChecked(True)
        self.chkRecordingNotes.setObjectName("chkRecordingNotes")
        self.verticalLayout_3.addWidget(self.chkRecordingNotes)
    ...
    def retranslateUi(self, frmFind):
        ...
        self.chkPhotoNotes.setText(_translate("frmFind", "Photo Notes"))
        ...
        self.chkRecordingNotes.setText(_translate("frmFind", "Recording Notes"))
