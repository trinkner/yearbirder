...
class Ui_frmFamilies(object):
    def setupUi(self, frmFamilies):
        ...
        self.gvPieChart.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        ...
        self.tblPieChartLegend.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.tblPieChartLegend.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.actionSetFamilyFilterToPieChartLegendFamily = QtGui.QAction(frmFamilies)
        self.actionSetFamilyFilterToPieChartLegendFamily.setObjectName("actionSetFamilyFilterToPieChartLegendFamily")
        self.actionSetFilterToFamily = QtGui.QAction(frmFamilies)
        self.actionSetFilterToFamily.setObjectName("actionSetFilterToFamily")
        self.actionSetFilterToSpecies = QtGui.QAction(frmFamilies)
