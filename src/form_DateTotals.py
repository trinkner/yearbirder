...
class Ui_frmDateTotals(object):
    def setupUi(self, frmDateTotals):
        ...
        self.tblYearTotals.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        ...
        self.actionSetDateFilter = QtGui.QAction(frmDateTotals)
        self.actionSetDateFilter.setObjectName("actionSetDateFilter")
        self.actionSetDateFilterToYear = QtGui.QAction(frmDateTotals)
        self.actionSetDateFilterToYear.setObjectName("actionSetDateFilterToYear")
        self.actionSetDateFilterToMonth = QtGui.QAction(frmDateTotals)
