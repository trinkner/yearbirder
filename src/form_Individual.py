...
class Ui_frmIndividual(object):
    def setupUi(self, frmIndividual):
        ...
        self.frameTop.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.frameTop.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.frameNames.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.frameNames.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.lblFirstSeen.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop)
        ...
        self.lblMostRecentlySeen.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop)
        ...
        self.horizontalLayout.addWidget(self.frameNames, 3)
        self.framePhoto = QtWidgets.QFrame(self.frameTop)
        self.framePhoto.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.framePhoto.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.framePhoto.setLineWidth(0)
        self.framePhoto.setObjectName("framePhoto")
        self.framePhoto.setVisible(False)
        self.layoutPhoto = QtWidgets.QVBoxLayout(self.framePhoto)
        self.layoutPhoto.setContentsMargins(4, 0, 4, 0)
        self.layoutPhoto.setSpacing(0)
        self.lblPhotoThumb = QtWidgets.QLabel(self.framePhoto)
        self.lblPhotoThumb.setAlignment(QtCore.Qt.AlignCenter)
        photoSizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Policy.Expanding,
            QtWidgets.QSizePolicy.Policy.Expanding)
        self.lblPhotoThumb.setSizePolicy(photoSizePolicy)
        self.lblPhotoThumb.setObjectName("lblPhotoThumb")
        self.layoutPhoto.addWidget(self.lblPhotoThumb)
        self.horizontalLayout.addWidget(self.framePhoto, 2)
        ...
        self.frameButtons.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
